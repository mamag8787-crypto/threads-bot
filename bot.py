...
def agent_writer(structure: str, ideas: str) -> str:
    prompt = (
        ...
        "СТИЛЬ:\n"
        "СТИЛЬ:\n"
        "- Разговорный живой слог — как будто говоришь другу\n"
        "- Никаких длинных тире — вместо них точка, запятая или новая строка\n"
        "- Предложения РАЗНОЙ длины: короткие рубленые и длинные плавные вперемешку\n"
        "- Посты разной длины: одни 150-200 символов, другие 400-500, не все одинаковые\n"
        "- Некоторые ключевые слова КАПСОМ для эмоции и акцента (2-4 слова на пост)\n"
        "- Эмоций больше: удивление, злость, радость, инсайт\n"
